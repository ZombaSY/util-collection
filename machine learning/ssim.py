...
img_path = 'A:/Users/SSY/Desktop/Other works/paper/졸업논문/experiments/Zero-DCE/result'
...
def main():
    ...
    df = {'file_name': img1_list,
          'A_percentage': ssim_list}

    pd.DataFrame(df).to_csv('ssim_result.csv', index=False)
